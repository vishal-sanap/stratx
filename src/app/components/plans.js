  ...
  return (
    <div className="w-full min-h-[100vh] text-white p-8 sm:p-12 md:p-24 gap-14 bg-[#FAF7F3] flex flex-col text-center md:text-left">
      <div className="w-full">
        ...
        <h2 className="text-2xl font-bold text-[#B27A50] text-left">Plans</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-12">
        <div>
          <h2 className="text-2xl font-bold text-[#B27A50] text-left">
            CZIP - Czech Passive Income Plan
          </h2>
          <h3 className="text-[#134155] text-lg sm:text-xl font-semibold mb-4 text-left">
